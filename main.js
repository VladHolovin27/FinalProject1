let modalauthentitication = document.querySelector(".my-modal");
let closeBtn = document.querySelector(".close-btn");

window.addEventListener("DOMContentLoaded", () => {
    modalauthentitication.style.display = "block";
});

window.addEventListener('click', (event) => {
  if (event.target === modalauthentitication) {
    modalauthentitication.style.display = "none";
  }
});
